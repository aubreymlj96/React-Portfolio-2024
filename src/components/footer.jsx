    ...
    return (
        <footer className="footer">
            <div className="footerContent text-centered">
                ...
                <img className="pp-images2" src="/github-logo.png" alt="github"/>
                </a>
                <a href='https://www.linkedin.com/in/aubrey-johnson-190704137/'>
                <img className="pp-images1" src="/vecteezy_linkedin-logo-png-linkedin-logo-transparente-png-linkedin_23986900.png" alt="linkedin"/>
                </a>
